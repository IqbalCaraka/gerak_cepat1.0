...
<html lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <!--    Favicons-->
    <!-- ===============================================-->
    <!-- <link rel="apple-touch-icon" sizes="180x180" href="{{asset('landing/img/favicons/apple-touch-icon.png')}}">
    ...
    <link rel="shortcut icon" type="image/x-icon" href="{{asset('landing/img/favicons/favicon.ico')}}"> -->
    ...
    <main class="main" id="top">
      <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" data-navbar-on-scroll="data-navbar-on-scroll">
        <div class="container"><a class="navbar-brand d-flex align-items-center fw-bold fs-2" href="index.html">
            <div class="text-warning">Gerak</div>
            <div class="text-1000">Cepat</div>
          </a>
          ...
          <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto pt-2 pt-lg-0">
              ...
              <li class="nav-item" data-anchor="data-anchor"><a class="nav-link fw-medium" href="#tentang">Tentang</a></li>
              <li class="nav-item" data-anchor="data-anchor"><a class="nav-link fw-medium" href="#layanan">Layanan</a></li>
              <li class="nav-item" data-anchor="data-anchor"><a class="nav-link fw-medium" href="#tim">Tim Kami</a></li>
            ...
            <form class="ps-lg-5" action="{{ route('login') }}">
                <button class="btn btn-lg btn-primary rounded-pill order-0" type="submit">Mulai Layananmu!</button>
            </form>
          </div>
        </div>
      </nav>
      <section class="py-0" id="home">
        <div class="bg-holder" style="background-image:url({{asset('landing/img/illustrations/hero-bg.png')}});background-position:bottom;background-size:cover;">
        </div>
        <!--/.bg-holder-->

        <div class="container position-relative">
          <div class="row align-items-center py-8">
            <div class="col-md-5 col-lg-6 order-md-1 text-center text-md-end"><img class="img-fluid" src="{{asset('landing/img/illustrations/mobile.png')}}" width="350" alt="" /></div>
            <div class="col-md-7 col-lg-6 text-center text-md-start"><span class="badge bg-light rounded-pill text-dark align-items-center d-flex flex-row-reverse justify-content-end mx-auto mx-md-0 ps-0 w-75 w-sm-50 w-md-75 w-xl-50 mb-3">#digitalisasi layanan sub umum<img class="img-fluid float-start me-3" src="{{asset('landing/img/illustrations/arrow-right.png')}}" alt=""/></span>
              <h1 class="mb-4 display-3 fw-bold lh-sm">Gerak Cepat <br class="d-block d-lg-none d-xl-block" /></h1>
              <p class="mt-3 mb-4 fs-1">Halo Orang Baik! Selamat datang di Layanan Digital Manajemen Aset<br class="d-none d-lg-block" />Subumum Kanreg VIII BKN!</p><a class="btn btn-lg btn-primary rounded-pill hover-top" href="#tentang" role="button">Cari yang kamu perlukan!</a>
        ...
        <div class="container">
          <div class="row justify-content-center mb-6">
            <div class="col-lg-6 text-center mx-auto mb-3 mb-md-5 mt-4">
              <h6 class="fw-bold fs-4 display-3 lh-sm">Lebih Lanjut Tentang <br />GERAK CEPAT </h6>
              <p class="mb-0">GERAK CEPAT diciptakan untuk memudahkanmu dalam mendapatkan semua layanan di Sub Umum melalui pelayanan digital yang cepat, efisien, dan transparan!</p>
            </div>
          </div>
          <div class="row">
            <div class="col-md-4 mb-6">
              <div class="text-center px-lg-3"><img class="img-fluid mb-3" src="{{asset('landing/img/illustrations/app.png')}}" width="90" alt="" />
                <h5 class="fw-bold">Berkelanjutan</h5>
                <p class="mb-md-0">Gerak Cepat sebuah ekosistem sistem informasi yang selalu berkembang dengan kebutuhan layanan.</p>
              </div>
            </div>
            <div class="col-md-4 mb-6">
              <div class="text-center px-lg-3"><img class="img-fluid mb-3" src="{{asset('landing/img/illustrations/cloud.png')}}" width="90" alt="" />
                <h5 class="fw-bold">Terintegrasi</h5>
                <p class="mb-md-0">Melalui Gerak Cepat, seluruh layanan yang ada pada Sub Umum dapat saling terintegrasi satu sama lain.</p>
              </div>
            </div>
            <div class="col-md-4 mb-6">
              <div class="text-center px-lg-3"><img class="img-fluid mb-3" src="{{asset('landing/img/illustrations/time-award.png')}}" width="90" alt="" />
                <h5 class="fw-bold">Cepat</h5>
                <p class="mb-md-0">Cepat merupakan nilai utama pada Gerak Cepat, yang dapat memotong rantai proses bisnis dalam pelayanan di sub umum.</p>
              </div>
            </div>
            <div class="col-md-4 mb-6">
              <div class="text-center px-lg-3"><img class="img-fluid mb-3" src="{{asset('landing/img/illustrations/customization.png')}}" width="90" alt="" />
                <h5 class="fw-bold">Terbuka</h5>
                <p class="mb-md-0">Gerak Cepat merupakan sistem informasi yang bersifat terbuka. Kamu pun dapat ikut andil dalam mengembangkan aplikasi ini agar menjadi lebih baik.</p>
              </div>
            </div>
            <div class="col-md-4 mb-6">
              <div class="text-center px-lg-3"><img class="img-fluid mb-3" src="{{asset('landing/img/illustrations/ux.png')}}" width="90" alt="" />
                <h5 class="fw-bold">Terencana</h5>
                <p class="mb-md-0">Gerak Cepat diciptakan dengan perencanaan dan pemetaan proses bisnis yang detail, sehingga dapat tepat sasaran dalam memenuhi keperluan layanan.</p>
              </div>
            </div>
            <div class="col-md-4 mb-6">
              <div class="text-center px-lg-3"><img class="img-fluid mb-3" src="{{asset('landing/img/illustrations/support.png')}}" width="90" alt="" />
                <h5 class="fw-bold">Customer Support</h5>
                <p class="mb-md-0">Apabila kamu kebingungan menggunakan layanan Gerak Cepat, kami selalu ada untuk memudahkan hal yang belum kamu pahami!</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section class="py-5" id="layanan">
        <div class="container-lg">
          <div class="row align-items-center">
            <div class="col-md-5 col-lg-6 order-md-0 text-center text-md-start"><img class="img-fluid" src="{{asset('landing/img/illustrations/feature-bg.png')}}" width="550" alt="" /></div>
            <div class="col-md-7 col-lg-6 px-sm-5 px-md-0">
              <h6 class="fw-bold fs-4 display-3 lh-sm">Layanan Kami <br /></h6>
              <p class="my-4">Cari layanan yang kamu perlukan disini. <br class="d-none d-xl-block" /></p>
              <div class="d-flex align-items-center mb-5">
                <div><img class="img-fluid" src="{{asset('landing/img/illustrations/fast-performance.png')}}" width="90" alt="" /></div>
                <div class="px-4">
                  <h5 class="fw-bold text-danger">PERBAIKAN</h5>
                  <p>Kamu dapat mengajuakan perbaikan BMN! <br class="d-none d-xl-block">Tentunya kami akan cepat respon periksa kerusakan BMN.<br class="d-none d-xl-block">Ayo coba fiturnya!</p>
                </div>
              </div>
              <div class="d-flex align-items-center mb-5">
                <div><img class="img-fluid" src="{{asset('landing/img/illustrations/prototype.png')}}" width="90" alt="" /></div>
                <div class="px-4">
                  <h5 class="fw-bold text-primary">Kebutuhan</h5>
                  <p>Memerlukan BMN? <br class="d-none d-xl-block">Kamu dapat menggunakan layanan Kebutuhan <br class="d-none d-xl-block"> untuk memenuhi keperluan operasional kerjamu!</p>
                </div>
              </div>
              <div class="d-flex align-items-center mb-5">
                <div><img class="img-fluid" src="{{asset('landing/img/illustrations/vector.png')}}" width="90" alt="" /></div>
                <div class="px-4">
                  <h5 class="fw-bold text-success">PINJAM RUANG DAN KENDARAAN</h5>
                  <p>Ketika kamu memerlukan ruangan, rumah dinas, <br class="d-none d-xl-block"> dan kendaraan untuk mendukung kegiatanmu, <br class="d-none d-xl-block"> layanan ini adalah pilihan yang tepat untukmu! </p>
                </div>
              </div>
              <div class="d-flex align-items-center mb-5">
                  <a class="btn btn-lg btn-primary rounded-pill hover-top" href="{{ route('login') }}" role="button">Mulai Sekarang!</a>
              </div>
            </div>
          </div>
        </div>
      ...
      <section class="py-8" id="tim">
        <div class="container-lg">
          <div class="row flex-center">
            <div class="col-sm-10 col-md-5 col-lg-5 order-md-0 text-center text-md-start"><img class="img-fluid mb-4" src="{{asset('landing/img/illustrations/testimonial.png')}}" alt="" /></div>
            <div class="col-sm-10 col-md-6 col-lg-6 text-center text-md-start offset-md-1">
              <h6 class="fw-bold fs-4 display-3 lh-sm"> Ayo bertemu dengan Tim <br />GERAK CEPAT</h6>
              <p class="my-4 pe-xl-5"> Tim Gerak Cepat adalah orang-orang luar biasa yang dengan sepenuh hati memberikan layanan terbaik untuk kamu!.</p>
              <div class="carousel slide" id="carouselExampleDark" data-bs-ride="carousel">
                <div class="carousel-inner">
                  <div class="carousel-item active" data-bs-interval="10000">
                    <div class="row h-100">
                      <div class="col-12">
                        <h5 class="my-4 fw-bold lh-sm">Iqbal Caraka Altino</h5>
                        <p class="mb-0 text-center text-md-start">"Kalau bisa besok, kenapa harus sekarang!"</p>
                      </div>
                      <div class="col-xl-6 pt-4 d-flex d-sm-block flex-center">
                        <div class="d-flex align-items-md-center"><img class="img-fluid me-4 me-md-3 me-lg-4" src="{{asset('landing/img/gallery/iqbal.png')}}" width="100" alt="" />
                          <div class="w-lg-50 my-3">
                            <h5 class="mb-0 fw-bold">Analis Data</h5>
                            <!-- <p class="fw-normal mb-0">"Tetap Putus Asa dan Jangan Semangat!"</p> -->
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="carousel-item" data-bs-interval="2000">
                    <div class="row h-100">
                      <div class="col-12">
                        <h5 class="my-4 fw-bold lh-sm">Jhon Rafles</h5>
                        <p class="mb-0 text-center text-md-start">"Santai aja besok bisa selesa!"</p>
                      </div>
                      <div class="col-xl-6 pt-4 d-flex d-sm-block flex-center">
                        <div class="d-flex align-items-md-center"><img class="img-fluid me-4 me-md-3 me-lg-4" src="{{asset('landing/img/gallery/jhon.jpeg')}}" width="100" alt="" />
                          <div class="w-lg-50 my-3">
                            <h5 class="mb-0 fw-bold">Analis Data</h5>
                            <!-- <p class="fw-normal mb-0">"Tetap Putus Asa dan Jangan Semangat!"</p> -->
                          </div>
        ...
        <!-- <div class="container">
          ...
          <div class="row">
            <div class="col-md-4 col-lg-3 offset-lg-1 mb-4">
              <div class="py-4"><img class="img-fluid" src="{{asset('landing/img/illustrations/automatic.png')}}" width="90" alt="" /></div>
      ...
      <!-- <section class="py-6"> -->
        ...
        <!-- <div class="container">
          <div class="container">
            <div class="row align-items-center">
              <div class="col-md-5 order-md-1 text-center text-md-start"><img class="img-fluid mb-4" src="{{asset('landing/img/illustrations/ultimate-feature.png')}}" alt="" /></div>
              <div class="col-md-6 text-center text-md-start">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="mb-4">
                      <div class="py-4"><img class="img-fluid" src="{{asset('landing/img/illustrations/app.png')}}" width="90" alt="" /></div>
                  ...
                  <div class="col-md-6">
                    <div class="mb-4">
                      <div class="py-4"><img class="img-fluid" src="{{asset('landing/img/illustrations/ux.png')}}" width="90" alt="" /></div>
                  ...
                  <div class="col-md-6">
                    <div class="mb-4">
                      <div class="py-4"><img class="img-fluid" src="{{asset('landing/img/illustrations/cloud.png')}}" width="90" alt="" /></div>
                  ...
                  <div class="col-md-6">
                    <div class="mb-4">
                      <div class="py-4"><img class="img-fluid" src="{{asset('landing/img/illustrations/support.png')}}" width="90" alt="" /></div>
        ...
        <div class="container">
          <div class="row flex-center">
            <div class="col-auto mb-5"><a class="pe-2 d-flex align-items-center text-decoration-none fw-bold fs-3" href="#">
                <div class="text-warning">Gerak</div>
                <div class="text-white">Cepat</div>
              </a></div>
          </div>
          <div class="row flex-center">
            <div class="col-auto mb-5">
              <ul class="list-unstyled list-inline mb-0">
                ...
                <li class="list-inline-item me3 me-sm-4"><a class="text-light text-decoration-none" href="#tentang">Tentang</a></li>
                <li class="list-inline-item me3 me-sm-4"><a class="text-light text-decoration-none" href="#layanan">Layanan</a></li>
                <li class="list-inline-item me3 me-sm-4"><a class="text-light text-decoration-none" href="#tim">Tim Kami</a></li>
          ...
          <div class="row flex-center">
            <div class="col-auto">
              <p class="mb-0 fs--1 text-700">&copy; This tample is made with&nbsp;
                ...
                </svg>&nbsp;by&nbsp;<a class="text-700" href="https://themewagon.com/" target="_blank">Tim Hore Kelompok 6</a>
              </p>
            </div>
          </div>
        </div>
