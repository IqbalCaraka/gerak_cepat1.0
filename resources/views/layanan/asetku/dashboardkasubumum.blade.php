@extends('layouts.layanankasubumum')
@section('content')
                      ...
                      <table class="display" id="basic-1" cellspacing="0">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td>Kebutuhan</td>
                            <td>1</td>
                            <td id="statusPengajuanKebutuhan">Menunggu persetujuan Kepala Subbagian Umumum</td>
                            <td> 
                              <ul class="action"> 
                          ...
                          <tr>
                            ...
                            <td>Perbaikan</td>
                            <td>1</td>
                            <td id="statusPengajuanPerbaikan">Menunggu persetujuan Kepala Subbagian Umum</td>
                            <td> 
                              <ul class="action"> 
                            ...
                            <div class="table-responsive">
                                <table class="display" width="100%" id="basic-9" cellspacing="0">
                                    ...
                                    <tr>
                                        <td>1</td>
                                        <td>Laptop</td>
                                        <td id="pengusulan">Pengadaan</td>
                                        <th id="statusDetailPengajuanKebutuhan">Menunggu persetujuan Kasub Umum</th>
                                        <td> 
                                            <ul class="action"> 
                                                ...
                                                <li class="edit"> <a href="#"><i  style="color:yellow" data-feather="edit" data-toggle="tooltip" data-placement="top" title="Proses Pengajuan" data-bs-toggle="modal" data-bs-target="#modalRevisi"></i></a></li>
                            ...
                            <div class="table-responsive">
                                <table class="display" width="100%" id="basic-6" cellspacing="0">
                                    ...
                                    <tr>
                                        ...
                                        <td>2020</td>
                                        <th id="statusPerbaikan">Persetujuan pemeriksaan</th>
                                        <td> 
                                        <ul class="action"> 
...
<!-- Modal detail pengajuan perbaikan-->
<div class="modal fade bd-example-modal-lg" id="modalRevisi" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
            <h4 class="modal-title" id="myLargeModalLabel">Pengajuan--KBN2023112500124</h4>
            ...
            <div class="modal-body">
                <div class="card">
                    ...
                    <form class="form theme-form">
                        ...
                        <div class="card-footer text-end">
                            <button class="btn btn-primary" type="button" onclick="isiPengadaanRevisi()">Proses Perbaikan</button>
                            <button class="btn btn-secondary" type="button" data-bs-dismiss="modal">Cancel</button>
                        </div>
                    </form>
                </div>
...
@push('scripts')
    ...
    <script>
        function isiPengadaanSetuju(){
            ...
            x.innerHTML = "Disetujui Kasub Umum"
        }
        ...
        function isiPengadaanTolak(){
            var x = document.getElementById("statusDetailPengajuanKebutuhan")
            x.innerHTML = "Ditolak Kasub Umum"
        }
        function ajukanProses(){
            ...
            if(y.innerHTML=="Disetujui Kasub Umum"){
                x.innerHTML = "Proses Pengadaan PBJ"
            }else if(y.innerHTML=="Revisi"){
                x.innerHTML = "Revisi"
            }
            else{
                x.innerHTML = "Ditolak"
    ...
    <script>
        function isiPemeriksaanSetuju(){
            ...
            x.innerHTML = "Pemeriksaan Teknisi"
        }

        function isiPemeriksaanTolak(){
            var x = document.getElementById("statusPerbaikan")
            x.innerHTML = "Tolak Pemeriksaan"
        }
        function prosesPengajuan(){
            ...
            if(y.innerHTML=="Pemeriksaan Teknisi"){
                x.innerHTML = "Pemeriksaan Teknisi"
            }else{
                x.innerHTML = "Ditolak"
            }
