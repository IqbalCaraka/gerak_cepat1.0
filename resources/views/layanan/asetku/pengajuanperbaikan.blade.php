...
<div class="container-fluid">
                ...
                <div class="col-sm-12 box-col-12">
                    <div class="card">
                        <div class="card-header mb-3 d-flex align-items-center justify-content-between pb-0">
                            <h5>Status Pengajuan Perbaikan BMN</h5>
                        ...
                        <div class="col-xl-12 col-sm-12" id="pengajuan">
                                    ...
                                    <div class="col-xl-9 col-12">
                                        <div class="blog-details">
                                            <div class="blog-date"><span>05</span> January 2021</div><a href="learning-detailed.html">
                                                <h6>Nomor pengajuan: PBN0231651616161651 </h6></a>
                            ...
                            <div class="card">
                                <div class="blog-box blog-list row">
                                    ...
                                    <div class="col-xl-9 col-12">
                                        <div class="blog-details">
                                            <div class="blog-date"><span>01</span> January 2020</div><a data-bs-toggle="modal" data-bs-target=".modal-revisi" href="#">
                                                <h6>Nomor pengajuan: PBN0233211616161651 </h6></a>
                                            <div class="blog-bottom-content">
                                                <ul class="blog-social">
                                                    <li>Laptop</li>
                                                    <li>3505178457721</li>
                                                ...
                                                <p class="mt-0">Catatan :</p>
                                                <p class="mt-0">Untuk p.c. yang rusak mohon diajukan sekalian</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="modal-body">
                <div class="card">
                  <div class="card-header pb-0">
                    <h5>Form Pengajuan Perbaikan</h5>
                  </div>
                  <form class="form theme-form">
                    <div class="card-body">
                      ...
                      <div class="row">
                        <div class="col">
                          <div class="mb-3">
                            <label class="form-label" for="exampleFormControlSelect17">Daftar BMN</label>
                            <div class="select2-drpdwn">
                                <select class="js-example-placeholder-multiple col-sm-12" multiple="multiple">
                                    <option>3505178457771--P.C. Unit--Dell</option>
                                    <option>3505178457721--Laptop--Acer</option>
                                </select>
                            </div>
                          </div>
                        </div>
    ...
    <div class="modal fade bd-example-modal-lg modal-revisi" tabindex="-1" role="dialog" id="modalRevisi" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        ...
        <div class="modal-content" id="modalRevisi">
            <div class="modal-header">
            <h4 class="modal-title" id="myLargeModalLabel">Pengajuan Nomor PBN0233211616161651</h4>
            <button class="btn-close" type="button" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="card">
                  <div class="card-header pb-0">
                    <h5>Form Pengajuan Perbaikan Revisi</h5>
                  </div>
                  <form class="form theme-form">
                    <div class="card-body">
                      <div class="row">
                        ...
                        <div class="col">
                          <div class="mb-3">
                            ...
                            <div class="select2-drpdwn">
                                <select class="js-example-placeholder-multiple col-sm-12" multiple="multiple">
                                    <option>3505178457771--P.C. Unit--Dell</option>
                                    <option selected="selected">3505178457721--Laptop--Acer</option>
                                </select>
                            </div>
                          </div>
                        </div>
