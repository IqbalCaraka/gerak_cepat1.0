                    ...
                    <div class="table-responsive">
                      <table class="display" id="basic-1" cellspacing="0">
                        ...
                        <tbody>
                          <tr>
                            <td>1</td>
                            <td>KBN2023112500124</td>
                            <td>Altino</td>
                            <td>25/11/2023</td>
                            <td>Kebutuhan</td>
                            <td>1</td>
                            <td id="statusPengajuanKebutuhan">Belum Diproses</td>
                            <td> 
                              <ul class="action"> 
                          ...
                          <tr>
                            ...
                            <td>Perbaikan</td>
                            <td>1</td>
                            <td id="statusPengajuanPerbaikan">Belum Diproses</td>
                            <td> 
                              <ul class="action"> 
...
<div class="modal fade bd-example-modal-lg" id="modalKebutuhan" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <h4 class="modal-title" id="myLargeModalLabel">Pengajuan--KBN2023112500124</h4>
                            ...
                            <div class="table-responsive">
                                <table class="display" width="100%" id="basic-9" cellspacing="0">
                                    ...
                                    <tr>
                                        ...
                                        <td> 
                                        <ul class="action"> 
                                            <li class="edit"> <a href="#"><i data-feather="arrow-right-circle" data-toggle="tooltip" data-placement="top" title="Proses Pengajuan" data-bs-toggle="modal" data-bs-target=".modal-cek"></i></a></li>
                                        </ul>
                                        </td>
                                    </tr>
                                    </tbody>
...
<div class="modal fade bd-example-modal-lg modal-cek" id="modalCek" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
            <h4 class="modal-title" id="myLargeModalLabel">Pengajuan--KBN2023112500124</h4>
            ...
            <div class="modal-body">
                <div class="card">
                    ...
                    <form class="form theme-form">
                            ...
                            <div class="table-responsive">
                                <table class="display" width="100%" id="basic-12" cellspacing="0">
                                    ...
                                    <tr>
                                        <td>1</td>
                                        <td>Laptop</td>
                                        <th>350517444895622</th>
                                        <td>Baik</td>
                                        <td>Lenovo</td>
                                        <td>2016</td>
                                        <td> 
                                            <ul class="action"> 
                                                <li class="edit"> <a href="#" onclick="isiPengajuan()"><i data-feather="arrow-right-circle" data-toggle="tooltip" data-placement="top" title="Proses Pengajuan"></i></a></li>
                                            </ul>
                                        </td>
                                    </tr>
                                    </tbody>
                        ...
                        <div class="card-footer text-end">
                            <a href="#" onclick="isiBuatPengadaan()">
                                <button class="btn btn-primary" type="button">Buat Pengadaan</button>
                            </a>
                            <button class="btn btn-secondary" type="button" data-bs-dismiss="modal">Cancel</button>
                        </div>
                    </form>
            ...
            <div class="modal-body">
                <div class="card">
                    ...
                    <form class="form theme-form">
                            ...
                            <div class="table-responsive">
                                <table class="display" width="100%" id="basic-6" cellspacing="0">
                                    ...
                                    <tr>
                                        ...
                                        <td>2020</td>
                                        <th id="statusPerbaikan">-</th>
                                        <td> 
                                        <ul class="action"> 
                                            <li class="edit"> <a href="#" onclick="isiPemeriksaan()"><i data-feather="arrow-right-circle" data-toggle="tooltip" data-placement="top" title="Proses Pengajuan"></i></a></li>
                                        </ul>
                                        </td>
                                    </tr>
                                    </tbody>
                        ...
                        <div class="card-footer text-end">
                            <a href="#" onclick="ajukanPemeriksaan()">
                                <button class="btn btn-primary" type="button">Ajukan</button>
                            </a>
                            <button class="btn btn-secondary" type="button" data-bs-dismiss="modal">Cancel</button>
                        </div>
...
@push('scripts')
    ...
    <script>
        function ajukanProses(){
            ...
            x.innerHTML = "Menunggu persetujuan Kepada Subbagian Umum"
            $('#modalKebutuhan').modal('hide');
        }
    </script>
     <script>
        function isiPemeriksaan(){
            var x = document.getElementById("statusPerbaikan")
            x.innerHTML = "Usul Pemeriksaan"
        }
    </script>
    <script>
        function ajukanPemeriksaan(){
