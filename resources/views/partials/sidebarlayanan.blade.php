                    ...
                    <ul>             
                        ...
                        <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="javascript:void(0)"><i data-feather="database"></i><span>Master Data</span></a>
                            <ul class="sidebar-submenu">
                                <li><a href="{{route('kelompokBMN.index')}}">Kelompok BMN</a></li>
                                <li><a href="{{route('subkelompokBMN.index')}}">Subkelompok BMN</a></li>
                                <li><a href="{{route('BMN.index')}}">BMN</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="{{route('riwayat.index')}}"><i data-feather="archive"></i><span>Riwayat BMN</span></a></li>
                        <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="{{route('dashboard.index')}}"><i data-feather="dollar-sign"></i><span>Anggaran</span></a></li>
                        <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="{{route('laporan.index')}}"><i data-feather="file-text"></i><span>Laporan</span></a></li>
                    </ul>
                </li>
            </ul>
            </div>
