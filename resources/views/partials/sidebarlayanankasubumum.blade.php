            ...
            <ul class="sidebar-links" id="simple-bar">
                ...
                <li class="menu-box"> 
                    <ul>             
                        ...
                        <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="{{route('dashboard.index')}}"><i data-feather="archive"></i><span>Riwayat BMN</span></a></li>
                        <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="{{route('dashboard.index')}}"><i data-feather="file-text"></i><span>Laporan</span></a></li>
                    </ul>
                </li>
            </ul>
            </div>
