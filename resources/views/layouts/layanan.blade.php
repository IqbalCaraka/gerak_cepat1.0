  ...
  <body>
    ...
    <div class="page-wrapper compact-wrapper" id="pageWrapper">
            ...
            <ul class="nav-menus">             
              ...
              <li class="profile-nav onhover-dropdown p-0 me-0">
                <div class="d-flex profile-media"><img class="b-r-50" src="../assets/images/dashboard/profile.jpg" alt="">
                  <div class="flex-grow-1"><span>Alexa</span>
                    <p class="mb-0 font-roboto">Pengelola BMN <i class="middle fa fa-angle-down"></i></p>
                  </div>
                </div>
                <ul class="profile-dropdown onhover-show-div">
                  <li><a href="{{route('pengguna.index')}}"><i data-feather="user"></i><span>Account </span></a></li>
                  <li><a href="#" data-bs-toggle="modal" data-bs-target="#yakinLogout"><i data-feather="log-in"> </i><span>Log out</span></a></li>
                </ul>
              </li>
            </ul>
          </div>
      ...
      <div class="page-body-wrapper default-menu default-menu">
        <!-- Page Sidebar Start-->
            @include('partials.sidebarlayanan')
        <!-- Page Sidebar Ends-->
        <div class="page-body">
            @yield('content')
        </div>
    ...
    <!-- Modal yakin logout -->
    <div class="modal fade" id="yakinLogout" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
