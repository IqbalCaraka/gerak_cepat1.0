  ...
  <body>
    ...
    <div class="page-wrapper compact-wrapper" id="pageWrapper">
            ...
            <ul class="nav-menus">             
              ...
              <li class="profile-nav onhover-dropdown p-0 me-0">
                <div class="d-flex profile-media"><img class="b-r-50" src="../assets/images/dashboard/profile.jpg" alt="">
                  <div class="flex-grow-1"><span>Sri</span>
                    <p class="mb-0 font-roboto">Kepala Bidang<i class="middle fa fa-angle-down"></i></p>
                  </div>
                </div>
      ...
      <div class="page-body-wrapper default-menu default-menu">
        <!-- Page Sidebar Start-->
            @include('partials.sidebarlayanankepalabidang')
        <!-- Page Sidebar Ends-->
        <div class="page-body">
            @yield('content')
        </div>
